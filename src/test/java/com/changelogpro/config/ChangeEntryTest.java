...
public class ChangeEntryTest {
    ...
    @Test
    public void testSetAndGetIssueId() {
        entry.setIssueId("PROJ-456");
        assertEquals("PROJ-456", entry.getIssueId());
    }

    @Test
    public void testSetAndGetPrNumber() {
    ...
    @Test
    public void testGenerateFileNameWithSpecialChars() {
    ...
    @Test
    public void testGenerateFileNameWithLongDescription() {
    ...
    @Test
    public void testGenerateFileNameWithEmptyDescription() {
    ...
    @Test
    public void testAllChangeTypesCanBeSet() {
    ...
    @Test
    public void testDeprecationEntry() {
